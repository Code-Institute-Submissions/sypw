...
def see_holiday(request):
    ...
    if request.method == "POST":
        ...
        send_mail(
            ...
            fail_silently=False,)
# In order for this function to work while there's no "manager_user" profile
# yet, all messages will be sent to a company account (DEFAULT...).
# Once account levels will be introdued, this bit will be changed
# to send it to the right manager.
